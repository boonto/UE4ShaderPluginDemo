...
void AShaderPluginDemoCharacter::SetupPlayerInputComponent(UInputComponent* InInputComponent)
{
	// set up gameplay key bindings
	check(InInputComponent);

	//ShaderPluginDemo Specific input mappings
	InInputComponent->BindAction("SavePixelShaderOutput", IE_Pressed, this,
							   &AShaderPluginDemoCharacter::SavePixelShaderOutput);
	InInputComponent->BindAction("SaveComputeShaderOutput", IE_Pressed, this,
							   &AShaderPluginDemoCharacter::SaveComputeShaderOutput);
	InInputComponent->BindAxis("ComputeShaderBlend", this,
	...
	{
		InInputComponent->BindAction("Fire", IE_Pressed, this,
								   &AShaderPluginDemoCharacter::OnFire);
	}

	InInputComponent->BindAxis("MoveForward", this,
							 &AShaderPluginDemoCharacter::MoveForward);
	InInputComponent->BindAxis("MoveRight", this,
	...
	UInputComponent* InInputComponent)
{
	...
	{
		bResult = true;
		InInputComponent->BindTouch(EInputEvent::IE_Pressed, this,
								  &AShaderPluginDemoCharacter::BeginTouch);
		InInputComponent->BindTouch(EInputEvent::IE_Released, this,
								  &AShaderPluginDemoCharacter::EndTouch);
		InInputComponent->BindTouch(EInputEvent::IE_Repeat, this,
